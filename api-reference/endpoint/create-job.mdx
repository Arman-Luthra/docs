...
Start a new document scraping job. Provide a website URL and natural language prompt describing what documents to find.
...
|-------|------|---------|-------------|
| `single_page` | boolean | `false` | Only scrape the provided URL, don't navigate |
...
| `max_file_size_mb` | integer | `100` | Maximum file size to download (1-500 MB) |
